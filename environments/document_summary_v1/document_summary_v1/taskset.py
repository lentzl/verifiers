...
MARKDOWN_OWNER_RECOVERY_FEEDBACK = (
    ...
    "its matching chapter_id and summary_path in the receipts dictionary. Only after "
    "all jobs are launched, if receipts are still missing, end this assistant turn with a brief waiting message "
